...
우선 $\tau$에 대한 c의 그래프를 그려봅니다.  
$\tau=0$인 경우는 없으므로 범위를 $[-10,-0.1], [0,10]$이렇게 두 개 나누어 그립니다. (양수에서 0으로 가는 극한값은 0이므로 0에서 10으로 범위를 잡아 넣었습니다.)

$[-10,-0.1]$ :  
![500](Pasted%20image%2020240614190824.png)

$[0, 10]$ :  
![500](Pasted%20image%2020240614191003.png)

이를 통해 c는 0보다 작은 경우가 없음을 알 수 있습니다.
따라서 
...
이제 MATLAB을 사용하여 $-\frac{b}{2} + \sqrt{c},\ -\frac{b}{2}- \sqrt{c},\ 1,\ -1$을 그려 비교합니다.
...
$[-10,-0.1]$ :  
![500](Pasted%20image%2020240614192304.png)

$[0, 10]$ :  
![500](Pasted%20image%2020240614192330.png)

이때 $\tau$ 의 양수 부분에서 각 함수의 극한값이 무엇인지 표시하였습니다. 
```Matlab

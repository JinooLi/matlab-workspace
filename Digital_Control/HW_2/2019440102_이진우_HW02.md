...
![500](Pasted%20image%2020240610162736.png)

이를 보면 경로가 정확히 -1을 지나는 것을 알 수 있습니다.

$K= 2$일 때는 다음과 같이 그려집니다.
...
![500](Pasted%20image%2020240610163159.png)

-1을 경로가 시계방향으로 한 번 감쌉니다. 따라서 $K=0.989$보다 크면 시스템이 안정하지 않음을 알 수 있습니다.

$K=0.5$일 때는 다음과 같이 그려집니다.
...
![500](Pasted%20image%2020240610163407.png)

-1을 경로가 감싸지 않습니다. 따라서 $K=0.989$보다 작으면 시스템이 안정함을 알 수 있습니다.
...
위상이 $-180$일 때 dB이 0에 가깝고, gain이 0에 가까운 모든 지점에서는 phase margin이 0 이상 있습니다.
...
위상이 -180일 때 dB이 -6으로 gain margin이 충분하고, phase margin도 충분한 것을 볼 수 있습니다. 따라서 이 상황에서는 시스템은 안정합니다.
